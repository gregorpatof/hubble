...
def scan_image(target_image, img_container, x_length=720, y_length=1280, step=100):
    ...
    min_dist, best_img, best_coords = scan_image_helper(target_image, img_container, scan_coords,
                                                        x_length, y_length, step)
    return min_dist, best_img, best_coords

def scan_image_helper(target_image, img_container, scan_coords,
...
def find_closest(n_closest, starting_image, img_containers, n_procs = 4):
    ...
    for i in range(1, n_closest):
        ...
        for img_container in img_containers:
            results.append(scan_image(current_image, img_container))
